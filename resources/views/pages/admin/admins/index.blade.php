                                            ...
                                            <form action="{{ route('users.update', 'test') }}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="col-md-12 make-space">
                                                            <label for="password" class="mr-sm-2">{{ trans('admins_trans.password') }} :</label>
                                                            <input type="password" class="form-control" name="password" value="">
                                                        </div>

                                                        <div class="col-md-12 make-space">
                                                            <label class="mr-sm-2" for="input-password-confirmation">{{ trans('admins_trans.confirm_password') }} :</label>

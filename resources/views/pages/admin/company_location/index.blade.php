                        ...
                        <?php $i = 0; ?>
                            ...
                            @foreach ($company_locations as $location)
                                <?php $i++; ?>
                                    ...
                                    <th><a href="{{ $location->link }}" target="_blank" style="color: blue">{{__('الذهاب للرابط')}}</a></th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('company_location.update', 'test') }}" method="post">
                                                ...
                                                <div class="row"  style="padding: 25px 0px 5px 0px;">
                                                    <div class="col">
                                                        <label for="link" class="mr-sm-2">{{__('الـرابـط') }} : <span style="color: red"> * </span> </label>
                                                        <input type="text" class="form-control" name="link" value="{{ $location->link }}" required>
                                                    </div>
                                                </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('company_location.store') }}" method="POST">
                    ...
                    <div class="row"  style="padding: 25px 0px 5px 0px;">
                        <div class="col">
                            <label for="link" class="mr-sm-2">{{__('الـرابـط') }} : <span style="color: red"> * </span> </label>
                            <input type="text" class="form-control" name="link" required placeholder="برجاء ادخال لينك URL">
                        </div>
                    </div>

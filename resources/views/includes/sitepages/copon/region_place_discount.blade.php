...
<body>
    ...
    <div class="images-sections py-4">
        <div class="container">
            <div class="row py-2">
                <?php  $count_discount = \App\Models\Place_Discount::where('type', 'عرض')->where('place_id', $place->id)->count();  ?>
                @if ($count_discount > '0')
                ...
                @else
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h1 style="text-align: center">عفوا لايوجد اي عروض في الوقت الحالي </h1>
                    </div>
                @endif
            </div>
